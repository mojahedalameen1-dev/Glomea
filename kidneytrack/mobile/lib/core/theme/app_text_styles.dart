...
class AppTextStyles {
  ...
  static TextStyle get h1 => arabicStyle.copyWith(
    fontSize: 32,
    fontWeight: isArabic ? FontWeight.w700 : FontWeight.w800, // Bold for Arabic, ExtraBold (800) for Inter
    height: 1.1,
  );

  static TextStyle get h2 => arabicStyle.copyWith(
    fontSize: 24,
    fontWeight: isArabic ? FontWeight.w600 : FontWeight.w700, // SemiBold for Arabic, Bold for Inter
    height: 1.2,
  );

  static TextStyle get h3 => arabicStyle.copyWith(
    fontSize: 18,
    fontWeight: isArabic ? FontWeight.w600 : FontWeight.w600, // SemiBold for both
    height: 1.3,
  );
  ...
  static TextStyle get label => arabicStyle.copyWith(
    fontSize: 14,
    fontWeight: isArabic ? FontWeight.w500 : FontWeight.w700, // Medium for Arabic, Bold for Inter
    height: 1.1,
  );
