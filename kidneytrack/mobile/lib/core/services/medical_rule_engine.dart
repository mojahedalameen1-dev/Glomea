...
class MedicalRuleEngine {
  ...
  static Map<String, IndicatorStatus> evaluateDailyTotal(
    Patient patient, {
    required double sodium,
    required double potassium,
    required double phosphorus,
    ...
    return {
      ...
      'potassium':
          _statusFromLimit(potassium, patient.potassiumLimitMg.toDouble()),
      'phosphorus':
          _statusFromLimit(phosphorus, patient.phosphorusLimitMg.toDouble()),
  ...
  static IndicatorStatus _statusFromThreshold(
