...
class _MeasureInputSheetState extends State<MeasureInputSheet> {
  ...
  void _onConfirm() {
    ...
    if (val < widget.min || val > widget.max) {
      setState(() => _error = 'القيمة يجب أن تكون بين ${widget.min.toInt()} و ${widget.max.toInt()} كحد أقصى');
      return;
    }
              ...
              children: [
                ...
                Stack(
                  ...
                  children: [
                    ...
                    Align(
                      alignment: Alignment.centerLeft, // Arabic LTR for close button if needed, but here it's RTL context
                      child: IconButton(
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    errorText: _error,
                    errorMaxLines: 2,
                    errorStyle: AppTextStyles.bodyS.copyWith(color: AppColors.textCritical),
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(24),
                      borderSide: BorderSide(color: isDark ? AppColors.borderBaseDark : AppColors.borderBase),
                    ),
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    elevation: 0,
                    minimumSize: const Size(double.infinity, 56), // Large touch target for seniors
                  ),
                  child: Text(
                    'تأكيد القيمة', 
