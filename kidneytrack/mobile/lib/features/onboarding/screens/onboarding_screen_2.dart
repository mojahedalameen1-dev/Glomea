...
class _OnboardingScreen2State extends ConsumerState<OnboardingScreen2> {
  ...
  void initState() {
    ...
    _fluidController = TextEditingController(text: (data.fluidLimitMl ?? HealthConstants.defaultFluidLimitMl).toString());
    _potassiumController = TextEditingController(text: (data.potassiumLimitMg ?? HealthConstants.defaultPotassiumLimitMg).toString());
    _sodiumController = TextEditingController(text: (data.sodiumLimitMg ?? HealthConstants.defaultSodiumLimitMg).toString());
    _proteinController = TextEditingController(text: (data.proteinLimitG ?? HealthConstants.defaultProteinLimitG).toString());
    _phosphorusController = TextEditingController(text: (data.phosphorusLimitMg ?? HealthConstants.defaultPhosphorusLimitMg).toString());
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildSectionTitle(isAr ? 'الحد اليومي للسوائل' : 'Daily Fluid Limit'),
                      AppTextField(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  isAr ? 'تلقي تذكيرات يومية لتسجيل مؤشراتك' : 'Get daily reminders for tracking',
            ...
            if (_formKey.currentState!.validate()) {
              ...
              notifier.updateData(
                state.data.copyWith(
                  ...
                  potassiumLimitMg: int.tryParse(_potassiumController.text),
                  sodiumLimitMg: int.tryParse(_sodiumController.text),
                  proteinLimitG: int.tryParse(_proteinController.text),
                  phosphorusLimitMg: int.tryParse(_phosphorusController.text),
