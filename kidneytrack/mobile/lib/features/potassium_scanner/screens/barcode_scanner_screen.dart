...
class _BarcodeScannerScreenState extends State<BarcodeScannerScreen>
  ...
  final MobileScannerController _controller =
      MobileScannerController(formats: const [BarcodeFormat.all]);
    ...
    return [
      Positioned(
          ...
          child: Container(
              ...
              height: t,
              decoration: const BoxDecoration(
                  color: c, borderRadius: BorderRadius.only(topLeft: r)))),
      Positioned(
          top: 0,
          left: 0,
          child: Container(
      ...
      Positioned(
          ...
          child: Container(
              ...
              height: t,
              decoration: const BoxDecoration(
                  color: c, borderRadius: BorderRadius.only(topRight: r)))),
      Positioned(
          top: 0,
          right: 0,
          child: Container(
      ...
      Positioned(
          ...
          child: Container(
              ...
              height: t,
              decoration: const BoxDecoration(
                  color: c, borderRadius: BorderRadius.only(bottomLeft: r)))),
      Positioned(
          bottom: 0,
          left: 0,
          child: Container(
      ...
      Positioned(
          ...
          child: Container(
              ...
              height: t,
              decoration: const BoxDecoration(
                  color: c, borderRadius: BorderRadius.only(bottomRight: r)))),
      Positioned(
          bottom: 0,
          right: 0,
          child: Container(
  ...
  Future<void> _onBarcodeDetected(
      BarcodeCapture capture, AppLocalizations l10n) async {
  ...
  void _showProductNotFound(String barcode, AppLocalizations l10n) {
    ...
    ScaffoldMessenger.of(context)
        .showSnackBar(SnackBar(content: Text(l10n.productNotFound(barcode))));
  }
                ...
                ElevatedButton(
                    onPressed: () {
                      ...
                      if (ctrl.text.isNotEmpty) {
                        _onBarcodeDetected(
                            BarcodeCapture(
                                barcodes: [Barcode(rawValue: ctrl.text)]),
                            l10n);
                      }
                    },
