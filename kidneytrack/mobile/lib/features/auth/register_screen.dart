  ...
  void _checkStrength(String val) {
    setState(() {
      if (val.isEmpty) {
        _strength = 0;
        _strengthLabel = '';
      } else if (val.length < 8 || !val.contains(RegExp(r'[A-Z]')) || !val.contains(RegExp(r'[0-9]'))) {
        _strength = 0.3;
  ...
  Future<void> _handleRegister() async {
    ...
    if (_passwordController.text != _confirmPasswordController.text) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('كلمات المرور غير متطابقة'), backgroundColor: AppColors.textCritical),
      );
      return;
    }
    ...
    try {
      ...
      if (error == null) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('تم إنشاء الحساب! يرجى مراجعة بريدك الإلكتروني لتأكيد الحساب قبل تسجيل الدخول.'),
                        ...
                        Transform.translate(
                            ...
                            decoration: const BoxDecoration(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text('إنشاء حساب جديد', style: AppTextStyles.h1.copyWith(fontSize: 26)),
                                  const SizedBox(height: 8),
                                  Text('ابدأ رحلتك نحو صحة أفضل اليوم', style: AppTextStyles.bodyM.copyWith(color: AppColors.textSecondary)),
                                  ...
                                  AppTextField(
                                    ...
                                    validator: (v) => v!.length < 8 ? 'يجب أن تكون ٨ محارف على الأقل' : null,
                                  ),
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Text('قوة كلمة المرور', style: AppTextStyles.bodyS),
                                            Text(_strengthLabel, style: AppTextStyles.bodyS.copyWith(color: _strengthColor, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                  ...
                                  AppTextField(
                                    ...
                                    validator: (v) => v != _passwordController.text ? 'لا تطابق كلمة المرور' : null,
                                  ),
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      child: AnimatedSwitcher(
                                        ...
                                        child: _isLoading 
                                          ...
                                          : Text('إنشاء الحساب', style: AppTextStyles.h2.copyWith(color: Colors.white)),
                                      ),
                                    ),
